...
function Home() {
  return (
    <div className="bg-[#F9F9F9]">
      ...
      <div className="bg-image w-screen bg-cover bg-center bg-no-repeat">
        <div className="bg-color flex items-center  ">
          <div className="md:px-10 px-4 flex flex-col space-y-6 relative bottom-6">
            ...
            <button className="bg-white text-[#DCA61D] hover:text-white hover:bg-[#DCA61D] w-40 py-3 font-medium text-lg">
              Nos activités
            </button>
          </div>
        </div>
      ...
      <div className="flex md:flex-row md:space-x-28 flex-col space-y-20 md:space-y-0 pt-20 justify-center items-center md:items-start">
        <div className="flex flex-col space-y-5 pl-4 sm:pl-0">
          ...
          <div className="sm:w-[500px] w-[320px] leading-loose">
            Integer vitae justo eget magna fermentum iaculis. Mattis rhoncus
            urna neque viverra. Nisi porta lorem mollis aliquam ut porttitor leo
            a diam. Dictum fusce ut placerat orci nulla pellentesque.
            <br />
            <br />
            Aenean euismod elementum nisi quis eleifend quam.Malesuada fames ac
            turpis egestas maecenas pharetra convallis posuere morbi. Morbi
            tristique senectus et netus et malesuada fames ac turpis. <br />
            <br />
            Sed blandit libero volutpat sed cras ornare. Cras adipiscing enim eu
            turpis egestas pretium aenean pharetra magna ....
          </div>
          <button className="hover:bg-white hover:text-[#066AB2] text-white bg-[#066AB2] w-40 py-3 font-medium text-lg">
            Notre mission
          </button>
        </div>
      ...
      <div className="pt-20 flex flex-col items-center space-y-4">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-12 pt-14">
            ...
            <div className="activite-img-taille">
                <div className="img-activite" style={{backgroundImage:`url(${activite1})`}}>
                <div className="bg-color-activite text-white pl-4 flex flex-col justify-end">
                    <div className="text-xl font-semibold w-72">
                    Duis aute irure dolor in reprehenderit
                    </div>
                    <div className=" italic font-light">Jeudi 23 mars 2024</div>

                    {/* button lire plus */}
                    <div className=" grid place-items-end">
                    <button className="flex flex-row items-center justify-center space-x-3 bg-[#DCA61D] rounded-s-full  py-2 w-[120px] ">
                        <svg
                        width="15"
                        height="15"
                        viewBox="0 0 15 15"
            ...
            {/* Activité 2 */}
            <div className="activite-img-taille">
                <div className="img-activite" style={{backgroundImage:`url(${activite2})`}}>
                <div className="bg-color-activite text-white pl-4 flex flex-col justify-end">
                    <div className="text-xl font-semibold w-72">
                    Duis aute irure dolor in reprehenderit
                    </div>
            ...
            {/* Activité 3 */}
            <div className="activite-img-taille">
                <div className="img-activite" style={{backgroundImage:`url(${activite3})`}}>
                <div className="bg-color-activite text-white pl-4 flex flex-col justify-end">
                    <div className="text-xl font-semibold w-72">
                    Duis aute irure dolor in reprehenderit
                    </div>
                ...
                <div className="grid sm:grid-cols-4 sm:gap-y-0 gap-y-8  mt-12 place-content-center place-items-center">
                  ...
                  <div>
                      ...
                      <div className="flex flex-col items-center space-y-2 w-[206px] p-3 pb-6 bg-white shadow">
                          <p className=" font-medium text-[#DCA61D] text-center">Presidente</p>
                          <p className="text-lg font-semibold text-[#4e4e4e] text-center">Touré Victoria</p>
                          {/* reseaux sociaux */}
                  ...
                  <div>
                      ...
                      <div className="flex flex-col items-center space-y-2 w-[206px] p-3 pb-6 bg-white shadow">
                          <p className=" font-medium text-[#DCA61D] text-center">Directeur</p>
                          <p className="text-lg font-semibold text-[#4e4e4e] text-center">Kouakou ange christ</p>
                          {/* reseaux sociaux */}
                          <div className="flex flex-row items-center space-x-2 pt-3">
                              <Link to="">
                                  <GrFacebookOption className="text-xl text-[#4e4e4e] bg-[#d9d9d9] hover:bg-[#066AB2] hover:text-white w-6 h-6 rounded-full p-1" />
                  ...
                  <div>
                      ...
                      <div className="flex flex-col items-center space-y-2 w-[206px] p-3 pb-6 bg-white shadow">
                          <p className=" font-medium text-[#DCA61D] text-center">Assistante</p>
                          <p className="text-lg font-semibold text-[#4e4e4e] text-center">koudou hermine</p>
                          {/* reseaux sociaux */}
                          <div className="flex flex-row items-center space-x-2 pt-3">
                              <Link to="">
                                  <GrFacebookOption className="text-xl text-[#4e4e4e] bg-[#d9d9d9] hover:bg-[#066AB2] hover:text-white w-6 h-6 rounded-full p-1" />
                  ...
                  <div>
                      ...
                      <div className="flex flex-col items-center space-y-2 w-[206px] p-3 pb-6 bg-white shadow">
                          <p className=" font-medium text-[#DCA61D] text-center">Interprete</p>
                          <p className="text-lg font-semibold text-[#4e4e4e] text-center">Yao christianah</p>
                          {/* reseaux sociaux */}
                          <div className="flex flex-row items-center space-x-2 pt-3">
                              <Link to="">
                                  <GrFacebookOption className="text-xl text-[#4e4e4e] bg-[#d9d9d9] hover:bg-[#066AB2] hover:text-white w-6 h-6 rounded-full p-1" />
      ...
      {/* newsletter */}
      <div className="mt-60">
        <div className="bg-cover bg-center bg-no-repeat h-full sm:h-[280px]" style={{backgroundImage:`url(${back_newletter})`}}>
          <div className="bg-[#DCA61D76] h-[280px] flex flex-col items-center justify-center space-y-3">
            <p className="text-center  sm:w-[600px] text-white font-bold text-2xl">Restez informer en vous abonnant a nos newsletter</p>
            <p className="text-lg text-white text-center">Veuillez entrer votre adresse mail</p>
            {/* barre de recherche */}
            <div className="flex items-center pt-4">
              <input type="search" placeholder="andreakonan87@gmail.com" className=" outline-none px-4 sm:w-[500px] h-12"/>
              <button className="bg-[#066AB2] text-white sm:w-[100px] h-12 s:px-2 sm:px-0 ">S'abonner</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-20 flex flex-col items-center">
        <p className=" uppercase text-2xl font-semibold text-[#4e4e4e]">nos partenaires</p>
