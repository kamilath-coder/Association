        ...
        <>
          <div className="bg-[#F9F9F9]">
           ...
           <SlideHome  banner={Banner}/>
            ...
            {/* Card option */}
            <div className="animation-card grid sm:grid-cols-2 lg:grid-cols-2md:grid-cols-3 place-content-center place-items-center s:gap-10 md:gap-0 relative bottom-12 ">
              {/* card1 */}
