          ...
          <div>
            ...
            <div className="Animation-option flex md:flex-row flex-col md:space-y-0 space-y-14 my-20  px-10">
              <div className=" md:w-3/4">
                ...
                <div className="sm:w-[731px]">
                  <p className="text-2xl font-semibold pt-4 text-[#066AB2]">
                    ...
                    {currentLanguage==="fr" ? (Article?.fr_Name ? Article.fr_Name : 'Pourquoi nous rejoindre') : (Article?.Names? removeTags(Article.Names):'Duis aute irure dolor in reprehenderit')}
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-3 pt-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        <path
                          d="M13.9999 23.9167C19.4767 23.9167 23.9166 19.4769 23.9166 14C23.9166 8.52322 19.4767 4.08337 13.9999 4.08337C8.52309 4.08337 4.08325 8.52322 4.08325 14C4.08325 19.4769 8.52309 23.9167 13.9999 23.9167Z"
                          stroke="#4E4E4E"
                        />
                        <path
                          d="M19.25 14.0001H14.2917C14.2143 14.0001 14.1401 13.9694 14.0854 13.9147C14.0307 13.86 14 13.7858 14 13.7084V9.91675"
                          stroke="#4E4E4E"
                      ...
                      <p className=" font-thin italic">
                        {
                          Article?.item_dat? `${new Date(Article?.item_date).getHours().toString().padStart(2, '0')}h ${new Date(Article?.item_date).getMinutes().toString().padStart(2, '0')}`
                          : '10h20'
                        }
                      </p>
                    </div>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        <path
                          d="M15 3.01355C10.857 3.01355 7.5 6.35705 7.5 10.4985C7.5 17.6595 15 26.9986 15 26.9986C15 26.9986 22.5 17.658 22.5 10.4985C22.5 6.35855 19.143 3.01355 15 3.01355ZM15 14.6401C13.9259 14.6401 12.8957 14.2134 12.1362 13.4538C11.3767 12.6943 10.95 11.6642 10.95 10.59C10.95 9.51592 11.3767 8.48579 12.1362 7.72627C12.8957 6.96674 13.9259 6.54005 15 6.54005C16.0741 6.54005 17.1043 6.96674 17.8638 7.72627C18.6233 8.48579 19.05 9.51592 19.05 10.59C19.05 11.6642 18.6233 12.6943 17.8638 13.4538C17.1043 14.2134 16.0741 14.6401 15 14.6401Z"
                          fill="#4E4E4E"
                        />
                      </svg>
                      <p className=" font-thin italic">
              ...
              <div className=" md:w-1/4">
                ...
                <div className=" mt-20">
                  <p className="text-xl  font-medium pb-10">{t('Activités recentes')}</p>
                  <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1">
                    {/* Activité 1 */}
                    <div className="activite-img-taille">
                      <div
                        className="bg-cover bg-center bg-no-repeat h-[200px] w-[250px] rounded-lg"
                      ...
                      >
                        <div className=" bg-[#066AB225] h-[200px] w-[250px] text-white pl-4 flex flex-col justify-end">
                          ...
                          {currentLanguage==="fr" ? (ArticleLast?.fr_Name ? ArticleLast.fr_Name : 'Pourquoi nous rejoindre') : (ArticleLast?.Names? removeTags(ArticleLast.Names):'Duis aute irure dolor in reprehenderit')}

                          </div>
                          <div className=" italic font-light text-sm">
                          {currentLanguage==="fr" ? (ArticleLast?.item_date ? new Date(ArticleLast.item_date).toLocaleDateString('fr-FR', options): 'Jeudi 23 Mars 2024') : (
                          ArticleLast?.item_date ? new Date(ArticleLast.item_date).toLocaleDateString('en-EN', options): 'Thursday, 23 March 2024')
                          }
                          </div>
