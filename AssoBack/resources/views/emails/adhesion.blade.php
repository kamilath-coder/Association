...
@section('content')
    ...
    <div class="row">
        {{-- {!! $request->message !!} --}}
        <div>
            <h4 class="text-center fw-bold mb-5">Vous message d'adhesion a éte envoyé vous recevrez bientot une reponse
                de confirmation.
                <br>

                voici  le contenu de votre demande  </h4>
        </div>
    </div>
    <div>
        <fieldset class="border p-2">
            <legend class="float-none w-auto p-2 h5 fw-bold">Informations </legend>
            <ul class="list-group">
                <li class="list-group-item">
                    <span class="fw-bold">Nom : </span>
                    <span>{{ $datas['nom'] ?? null }}</span>
                </li>
                <li class="list-group-item">
                    <span class="fw-bold">Email : </span>
                    <span>{!! $datas['email'] ?? null !!}</span>
                </li>
            </ul>
        </fieldset>
        <fieldset class="border p-2">
            ...
            <ul class="list-group">
                <li class="list-group-item">
                    <span class="fw-bold">Raison  : </span>
                    <span>{!! $datas['raison'] ?? null !!}</span>
                </li>
